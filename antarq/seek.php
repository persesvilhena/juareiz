...
$res = mysqli_query($conecta, "SELECT * FROM `users1` where nome1 like '%$seek%';"); /*Executa o comando SQL, no caso para pegar todos os usuarios do sistema e retorna o valor da consulta em uma variavel ($res)  */
$res = mysqli_query($conecta, "SELECT * FROM `users1` where nome2 like '%$seek%';");
$res = mysqli_query($conecta, "SELECT * FROM `users1` where nome like '%$seek%';");
