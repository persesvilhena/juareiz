...
$res1 = mysqli_query($conecta, "select * from grupos where id = '$uid';");
...
$res = mysqli_query($conecta, "select * from us_grupo where grupo = '$uid';"); /*Executa o comando SQL, no caso para pegar todos os usuarios do sistema e retorna o valor da consulta em uma variavel ($res)  */
...
if(isset($_POST["ver"])) { // Verifico se o botão cadastrar foi acionado
		...
		$repeat_user = mysqli_query($conecta, "SELECT * FROM us_grupo WHERE us='$id_gen' AND grupo='$uid';");
