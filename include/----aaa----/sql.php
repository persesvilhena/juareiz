...
$res = mysqli_query($conecta, "SELECT * FROM `users1` ORDER BY id DESC;"); /*Executa o comando SQL, no caso para pegar todos os usuarios do sistema e retorna o valor da consulta em uma variavel ($res)  */
...
$res1 = mysqli_query($conecta, "SELECT * FROM `foto` where nome='$escrever[id]';"); /*Executa o comando SQL, no caso para pegar todos os usuarios do sistema e retorna o valor da consulta em uma variavel ($res)  */
